...
fn authority_round() {
    ...
    net.peer(0)
        ...
        .import_own_transaction(
            &*net.peer(0).chain,
            new_tx(s0.secret(), 0.into(), chain_id),
            false,
        )
        .unwrap();
    net.peer(1)
        ...
        .import_own_transaction(
            &*net.peer(1).chain,
            new_tx(s1.secret(), 0.into(), chain_id),
            false,
        )
        .unwrap();
    // Sync a block
    ...
    net.peer(0)
        ...
        .import_own_transaction(
            &*net.peer(0).chain,
            new_tx(s0.secret(), 1.into(), chain_id),
            false,
        )
        .unwrap();
    net.peer(1)
        ...
        .import_own_transaction(
            &*net.peer(1).chain,
            new_tx(s1.secret(), 1.into(), chain_id),
            false,
        )
        .unwrap();
    ...
    net.peer(0)
        ...
        .import_own_transaction(
            &*net.peer(0).chain,
            new_tx(s0.secret(), 2.into(), chain_id),
            false,
        )
        .unwrap();
    net.peer(1)
        ...
        .import_own_transaction(
            &*net.peer(1).chain,
            new_tx(s1.secret(), 2.into(), chain_id),
            false,
        )
        .unwrap();
    ...
    net.peer(0)
        ...
        .import_own_transaction(
            &*net.peer(0).chain,
            new_tx(s0.secret(), 3.into(), chain_id),
            false,
        )
        .unwrap();
    net.peer(1)
        ...
        .import_own_transaction(
            &*net.peer(1).chain,
            new_tx(s1.secret(), 3.into(), chain_id),
            false,
        )
        .unwrap();
    ...
    net.peer(1)
        ...
        .import_own_transaction(
            &*net.peer(1).chain,
            new_tx(s1.secret(), 4.into(), chain_id),
            false,
        )
        .unwrap();
    net.peer(1).chain.engine().step();
